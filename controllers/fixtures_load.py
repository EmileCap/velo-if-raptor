...
def fct_fixtures_load():
    ...
    sql = """
    INSERT INTO Velo(
        nom_velo, prix_velo, description_velo, photo_velo, stock_velo,
        matiere_velo, couleure_velo, marque_velo, fournisseur_velo, Id_taille, Id_type
    ) VALUES
    ...
    sql = """
    INSERT INTO panier(taille_panier, prix_panier)
    VALUES ('M', '2300');
    """
    mycursor.execute(sql)
